  ...
  static async updateMovimentacaoFinanceira(id, dadosAtualizados) {
    try {
      return await sequelize.transaction(async (transaction) => {
        ...
        if (!movimentacao) {
          throw new Error('Movimenta��o financeira n�o encontrada');
        }
        ...
        if (totalComAjustes < 0) {
          throw new Error('Desconto maior que o valor da parcela com acr�scimo.');
        }
      ...
      console.error('Erro ao atualizar movimenta��o financeira:', error);
      throw new Error('Erro ao atualizar movimenta��o financeira');
    }
  }
